...
function doGet(e) {
  ...
  template.data = {
    ...
    assignedTeacherId: String(e.parameter.assignedTeacherId || ""),
    assignedTeacherName: String(e.parameter.assignedTeacherName || ""),
    assignedTeacherEmail: String(e.parameter.assignedTeacherEmail || ""),
...
function uploadProject(formObject) {
  ...
  return {
    ...
    teacherId: String(formObject.assignedTeacherId || ""),
    teacherName: String(formObject.assignedTeacherName || ""),
    teacherEmail: String(formObject.assignedTeacherEmail || ""),
    title: projectTitle,
    description,
...
function persistProjectToFirestore_(requestId, formObject, file, projectTitle, description) {
  ...
  const payload = {
    fields: {
      ...
      teacherId: { stringValue: String(formObject.assignedTeacherId || "") },
      teacherName: { stringValue: String(formObject.assignedTeacherName || "") },
      teacherEmail: { stringValue: String(formObject.assignedTeacherEmail || "") },
